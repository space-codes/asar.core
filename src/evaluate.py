...
from sklearn.metrics import confusion_matrix, classification_report, recall_score, precision_score, roc_auc_score, \
    precision_recall_fscore_support, precision_recall_curve, average_precision_score, accuracy_score
...
class_names = np.unique(test_generator.labels)
...
cl_report = classification_report(test_generator.classes, Y_pred)
print(cl_report)

# Plot classification report
plt.figure()
plot_classification_report(cl_report)
